        ...
        <div className="cards-table">
          <div className="bronze-card card">
            ...
            <ul>
              ...
              <li>Door-to-door delivery option</li>
              <li>Invitations to 2 wine tastings per year</li>
              <li>Invitations to 2 estate events per year</li>
              <li>Access to estate for seasonal events</li>
            </ul>
          </div>
          ...
          <div className="card silver-card">
            ...
            <ul>
              <li>Premium wine selection</li>
              <li>Door-to-door delivery option</li>
              <li>Invitations to 4 wine tastings per year</li>
              <li>Invitations to 4 estate events per year</li>
              <li>Access to estate for seasonal and special events</li>
              <li>Invitations to sommelier group sessions</li>
              <li>Invitations to non-exclusive networking events</li>
              <li>Access to private sales selection</li>
            </ul>
          </div>
          ...
          <div className="gold-card card">
            ...
            <ul>
              ...
              <li>Access to private sales selection</li>
              <li>Door-to-door delivery option</li>
              <li>Invitations to 12 wine tastings per year</li>
              <li>Invitations to 8 estate events per year</li>
              <li>Access to estate for seasonal and special events</li>
              <li>Access to private sommelier group sessions</li>
              <li>Invitations to sommelier group sessions</li>
              <li>Invitations to exclusive and non-exclusive networking events</li>
              <li>Invitations to private dinners, private tours, and other experiences</li>
              <li>Access to private sales selection</li>
              <li>Ability to order specially-curated wines and other products</li>
            </ul>
          </div>
        </div>
      </div>
